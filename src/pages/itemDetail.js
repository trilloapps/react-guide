...
const EDIT_API_URL = 'https://api.apps-demo-2.trilloapps.com/ds/function/shared/EditLineItem';
const GET_DETAILS_API_URL = 'https://api.apps-demo-2.trilloapps.com/ds/function/shared/GetItemDetails';
const headers = {
  'Accept':'*/*',
  'x-app-name':'main',
  'x-org-name':'cloud',
